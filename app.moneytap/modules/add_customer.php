...
if (isset($_POST['add_customer'])) {
    ...
    $organization       = trim($_POST['organization']       ?? 'MoneyTap Ecosystem');
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0">Manually register a customer for MoneyTap Ecosystem</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="loan_type">
                                ...
                                <option value="Business Loan"<?php echo ($form_data['loan_type'] ?? '') === 'Business Loan'? 'selected' : ''; ?>>Business Loan (SME)</option>
                                <option value="Salary Loan"  <?php echo ($form_data['loan_type'] ?? '') === 'Salary Loan'  ? 'selected' : ''; ?>>Salary Loan</option>
                                <option value="Microfinance" <?php echo ($form_data['loan_type'] ?? '') === 'Microfinance' ? 'selected' : ''; ?>>Microfinance</option>
                                <option value="Asset Financing"<?php echo ($form_data['loan_type'] ?? '') === 'Asset Financing'? 'selected' : ''; ?>>Asset Financing</option>
