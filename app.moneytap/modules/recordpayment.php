...
<div class="print-header">
    ...
    <div class="print-company-info">
        <h1>MoneyTap Ecosystem</h1>
        <p><i class="fas fa-map-marker-alt"></i> Demo Office, Financial District</p>
        <p><i class="fas fa-phone"></i> +250 000 000 000 | <i class="fas fa-envelope"></i> hello@moneytap.rw</p>
        <p><i class="fas fa-toggle-on"></i> Open Core Banking Terminal</p>
    </div>
</div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <form method="POST" id="prepayForm" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select class="form-select form-select-sm" name="payment_method" required onchange="showLedgerInfo(this, 'prepay_ledger_info')">
                                        ...
                                        <div id="prepay_ledger_info" class="mt-2" style="display:none; font-size: 0.85rem;"></div>
                                    </div>
                                    <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="payment_method" required onchange="showLedgerInfo(this, 'regular_ledger_info')">
                                    <option value="">Select Method</option>
                                    <option value="Cash">Cash</option>
                                    <option value="Bank Transfer">Bank Transfer</option>
                                    <option value="Mobile Money">Mobile Money</option>
                                ...
                                <div id="regular_ledger_info" class="mt-2" style="display:none; font-size: 0.85rem;"></div>
                            </div>
                            <hr>
...
function generatePDF() {
    ...
    doc.text('moneytap', 45, 18);
    doc.setFontSize(9); doc.setFont('helvetica', 'normal'); doc.setTextColor(85, 85, 85);
    doc.text('Kigali, Rwanda', 45, 24);
    doc.text('Tel: +250 796 880 272 | Email: info@moneytap.rw', 45, 28);
    doc.text('Web: www.moneytap.rw', 45, 32);
...
endforeach; ?>
    ...
    for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text('moneytap', 105, doc.internal.pageSize.height - 16, { align: 'center' });
        doc.setFont('helvetica','normal'); doc.setFontSize(7); doc.setTextColor(100,100,100);
        doc.text('Kigali, Rwanda | Tel: +250 796 880 272 | Email: info@moneytap.rw | Web: www.moneytap.rw',
...
function showLedgerInfo(selectElement, infoDivId) {
    ...
    if (method === "Cash") {
        message = "Funds will immediately be logged to <strong style='color:#14A44D;'>Cash on Hand [1101]</strong>.";
        icon = 'fas fa-money-bill-wave';
        colorClass = 'text-success';
    } else if (method === "Mobile Money") {
        message = "Funds will sit in <strong style='color:#FB6340;'>Mobile Money Account [1103]</strong> until withdrawn to Bank or Cash.";
        icon = 'fas fa-mobile-alt';
        colorClass = 'text-warning';
    } else if (method === "Bank Transfer") {
        message = "Funds will be recorded directly into <strong style='color:#5E72E4;'>Bank Account [1102]</strong>.";
        icon = 'fas fa-university';
        colorClass = 'text-primary';
    } else if (method === "Cheque") {
        message = "Funds will be credited to <strong style='color:#5E72E4;'>Bank Account [1102]</strong>. <em>(Ensure funds clear first)</em>";
        icon = 'fas fa-money-check-alt';
        colorClass = 'text-info';
    }
    
    if (message !== "") {
        infoDiv.innerHTML = `<div class="p-2 rounded border" style="background-color:#f8f9fa; border-left: 4px solid ${getColorCode(colorClass)};"><i class="${icon} ${colorClass} me-1"></i> <span class="text-secondary">${message}</span></div>`;
...
function getColorCode(className) {
    if (className.includes('success')) return '#14A44D';
    if (className.includes('warning')) return '#FB6340';
    if (className.includes('primary')) return '#5E72E4';
    if (className.includes('info')) return '#0dcaf0';
    return '#ccc';
}
</script>
