# moneytap — Accounting & Loan Management System
...
### Installation Steps
1.  **Clone/Upload:** Upload the files to your server (e.g., `htdocs/moneytap_website`).
2.  **Database Config:**
...
5.  **Access:** Open your browser to `http://localhost/app.moneytap/login.php`.
...
---
© 2026 moneytap. Built for precision.
