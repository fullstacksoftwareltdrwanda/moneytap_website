...
foreach ($columns_to_add as $col => $type) {
    ...
    if ($res->num_rows == 0) {
        echo "Adding column $col to loan_portfolio...<br>";
...
if ($res->num_rows == 0) {
    echo "Adding column requested_amount_paid to loan_instalments...<br>";
    $conn->query("ALTER TABLE loan_instalments ADD requested_amount_paid DECIMAL(15, 2) DEFAULT 0.00");
}
