...
<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-primary sidebar">
    <div class="position-sticky pt-3">
        <div class="sidebar-header text-center py-4">
            <h5 class="text-white font-black uppercase tracking-tighter">
                <i class="fas fa-bolt text-brand-primary me-2"></i>
                Money<span class="text-brand-primary">Tap</span>
            </h5>
        </div>
        ...
        <div class="user-greeting text-center">
            ...
            <div class="text-white small fw-bold mb-1">Authenticated: <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'User'); ?></div>
            <div class="badge bg-brand-primary text-brand-dark rounded-pill px-3 py-1 mb-2" style="font-size: 0.65rem; font-weight: 800;">
            ...
            <div class="mt-1" style="font-size: 0.65rem; color: rgba(255,255,255,0.5);">
                <i class="bi bi-circle-fill text-brand-primary" style="font-size: 0.45rem;"></i> Ecosystem Active
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const messages = [
                "Fintech excellence.",
                "Realtime liquidity management.",
                "AI-driven financial solutions.",
                "MoneyTap Ecosystem v2.0"
            ];
            let messageIndex = 0;
            let charIndex = 0;
