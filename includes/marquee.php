    ...
    <div class="flex whitespace-nowrap animate-marquee">
        <div class="flex items-center space-x-12 px-12">
            <span class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] flex items-center gap-2">
                <i class="fas fa-bolt text-brand-primary"></i> Fast Approval
            </span>
            <span class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] flex items-center gap-2">
                <i class="fas fa-shield-alt text-brand-primary"></i> Secure Lending
            </span>
            <span class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] flex items-center gap-2">
                <i class="fas fa-percentage text-accent-gold"></i> Competitive Rates
            </span>
            <span class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] flex items-center gap-2">
                <i class="fas fa-clock text-brand-primary"></i> 24h Processing
            </span>
            <span class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] flex items-center gap-2">
                <i class="fas fa-user-check text-brand-primary"></i> Personalized Service
            </span>
        </div>
